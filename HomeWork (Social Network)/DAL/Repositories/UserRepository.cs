...
namespace HomeWork__Social_Network_.DAL.Repositories
{
    public class UserRepository : BaseRepository, IUserRepository
    {
        ...
        public UserEntity FindInfoUsers(string email)
        {

            return QueryFirstOrDefault<UserEntity>("select * from users where email = :temp_p", new { temp_p = email });
        }

        public UserEntity FindUserToEnter(string email)
        {
    ...
    public interface IUserRepository
    {
        ...
        UserEntity FindInfoUsers(string email);
        UserEntity FindUserToEnter(string email);
